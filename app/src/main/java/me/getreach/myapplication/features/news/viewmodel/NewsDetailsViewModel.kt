...
import me.getreach.myapplication.features.news.domain.repository.NewsDetailsRepository
    ...
    fun getNewsDetails(newsId: String) {
        viewModelScope.launch {
            ...
            try {
                ...
                _newsDetailState.value = NewsDetailState.Error("Failed to load news details: ${e.localizedMessage}")
            }
        }
    }
